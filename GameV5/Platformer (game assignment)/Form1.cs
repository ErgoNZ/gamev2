...
namespace Platformer__game_assignment_
{
    public partial class Form1 : Form
    {
        ...
        private void Gametick_Tick(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    else
                    {
                        if (level == 2)
                        {
                            ...
                            Spikes9.Show();
                            Spring.Show();
                            Door.Left = PnlGame.Width - 950;
                            Door.Top = PnlGame.Height - 375;
                            ground1.Show();
                            Bullet2.Show();
                        }
                        else
            ...
            if (right == true)
            {
                if (PlayerOne.Location.X > PnlGame.Width-20 )
                {
                    PlayerOne.Left = 960;
                }
                else
            ...
            if (level == 2)
            {
                if (PlayerOne.Bounds.IntersectsWith(Spring.Bounds))
                {
                    Jump = 0;
                    Ymovement = -15;
                }
                if (PlayerOne.Bounds.IntersectsWith(Spikes4.Bounds))
                {
                    PlayerOne.Left = PnlGame.Width - 950;
                    PlayerOne.Top = PnlGame.Height - 90;
                }
                if (PlayerOne.Bounds.IntersectsWith(Spikes5.Bounds))
                {
                    PlayerOne.Left = PnlGame.Width - 950;
                    PlayerOne.Top = PnlGame.Height - 90;
                }
                if (PlayerOne.Bounds.IntersectsWith(Spikes6.Bounds))
                {
                    PlayerOne.Left = PnlGame.Width - 950;
                    PlayerOne.Top = PnlGame.Height - 90;
                }
                if (PlayerOne.Bounds.IntersectsWith(Spikes7.Bounds))
                {
                    PlayerOne.Left = PnlGame.Width - 950;
                    PlayerOne.Top = PnlGame.Height - 90;
                }
                if (PlayerOne.Bounds.IntersectsWith(Spikes8.Bounds))
                {
                    PlayerOne.Left = PnlGame.Width - 950;
                    PlayerOne.Top = PnlGame.Height - 90;
                }
                if (PlayerOne.Bounds.IntersectsWith(Spikes9.Bounds))
                {
                    PlayerOne.Left = PnlGame.Width - 950;
                    PlayerOne.Top = PnlGame.Height - 90;
                }
                if (PlayerOne.Bounds.IntersectsWith(Bullet2.Bounds))
                {
                    PlayerOne.Left = PnlGame.Width - 950;
                    PlayerOne.Top = PnlGame.Height - 90;
                }
        ...
        private void Gravity_Tick(object sender, EventArgs e)
        {
          ...
          if (level == 2)
            {
                if (PlayerOne.Bounds.IntersectsWith(ground9.Bounds))
                {
                    if (PlayerOne.Location.Y < 250)
                    {
                        PlayerOne.Top = ground9.Top - 34;
                        Ymovement = 0;
                        Jump = 0;
                    }
                    else
                    {
                        PlayerOne.Top = ground9.Top + 45;
                        Ymovement = 0;
                    }
                }
                else
                    if (PlayerOne.Bounds.IntersectsWith(ground10.Bounds))
                {
                    if (PlayerOne.Location.Y < 250)
                    {
                        PlayerOne.Top = ground10.Top - 34;
                        Ymovement = 0;
                        Jump = 0;
                    }
                    else
                    {
                        PlayerOne.Top = ground10.Top + 45;
                        Ymovement = 0;
                    }
                }
            }
        ...
        private void turretTm_Tick(object sender, EventArgs e)
        {
            ...
            if (level == 2)
            {
                if (Bullet2.Location.X > PnlGame.Width)
                {
                    Bullet2.Left = -10;
                }
                else
